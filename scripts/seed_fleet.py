...
Flotte officielle — 12 coursiers :
  scoot_50 (Paris + Petite Couronne, 50cc) : KEN, MEH, LIM, MIC, MAT
  scoot_125   (Petite + Grande Couronne, 125cc+) : JC, MEF, ABD
  voiture        (toutes zones) : JEA, SET
...
# ---------------------------------------------------------------------------
COURIERS = [
    # ── scoot_50 — Paris intra-muros + Petite Couronne (50cc) ──
    {
        "code": "KEN",
    ...
    # ── scoot_125 — Petite + Grande Couronne (125cc+, voies rapides OK) ──
    {
        "code": "JC",
        "vehicle_type": "scoot_125",
    ...
    # ── voiture — spécialisé inter-villes et aéroports ──
    {
        "code": "JEA",

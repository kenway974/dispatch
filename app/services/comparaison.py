...
class CandidatEvalue:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "bonus_groupage": round(self.bonus_groupage, 2) if self.bonus_groupage is not None else None,
    ...
    for coursier in fleet.list_coursiers():
        ...
        if motif is not None:
            ecartes.append(CandidatEvalue(
                ...
                penalite_charge=None, penalite_vehicule=None, bonus_groupage=None,
        ...
        eligibles.append((detail.total, CandidatEvalue(
            ...
            bonus_groupage=detail.bonus_groupage,
